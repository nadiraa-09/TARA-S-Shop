...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-warning sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Pages Collapse Our Cakes -->
      <div class="sidebar-heading">
        Our Cakes
      </div>
      ...
      <li class="nav-item" styles="color:black;
      ">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="clBirthday1.php" class="d-none d-sm-inline-block btn btn-sm btn-warning shadow-sm"><i
                class="fas fa-fw fa-eye"></i></i> SHOW FRONT-END WEB</a>
          </div>
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-warning">BIRHDAY CAKE</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  include 'koneksi.php';
                  $no = 1;
                  $sql = mysqli_query($koneksi, "select*from birthday");
                  ...
                  ?>
                    <tr>
                      ...
                      <td><?php echo "<img src ='images/clBirthday/".$data['foto']."' width = '100' height = '100'>" ;?>
                      </td>
                      <td><i class="fas fa-edit bg-success p-2 text-white rounded"></i>
                        <a href="#" data-role="pop" data-id="<?php echo $data['kode'];?>">Edit</a>
                        <i class="fas fa-trash-alt bg-danger p-2 text-white rounded"></i>
                        <a href="#" data-role="pop2" data-id="<?php echo $data['kode']?>">Delete</a>
                    </tr>
                      ...
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="clBirthday_update.php" enctype="multipart/form-data" method="post">
                              <div class="form-row">
                    ...
                    <div class="modal fade" id="ModalDelete" tabindex="-1" role="dialog"
                      ...
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="clBirthday_delete.php" method="post">
  ...
  <div class="modal fade" id="modalSaya" tabindex="-1" role="dialog" aria-labelledby="modalSayaLabel"
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="clBirthday_upload.php" method="post" enctype="multipart/form-data">
            <div class="form-row">
              <div class="form-group col-md-6">
                <label>No</label>
    ...
    $("a[data-role=pop2]").click(function () {
      ...
      $.ajax({
        ...
        success: function (data) {
          ...
          var row = JSON.parse(data);
          console.log(row['kode']);
          $("#datadel2").val(row['kode']);
          $("#datadel").text(row['kode']);
