      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="clCostum1.php" class="d-none d-sm-inline-block btn btn-sm btn-warning shadow-sm"><i
                class="fas fa-fw fa-eye"></i></i> SHOW FRONT-END WEB</a>
          </div>
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-warning">COSTUM CAKE</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  include 'koneksi.php';
                  $no = 1;
                  $sql = mysqli_query($koneksi, "select*from costum");
                  ...
                  ?>
                    <tr>
                      ...
                      <td><?php echo "<img src ='images/clCostum/".$data['foto']."' width = '100' height = '100'>" ;?>
                      </td>
                      ...
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="clCostum_update.php" enctype="multipart/form-data" method="post">
                              <div class="form-row">
                    ...
                    <div class="modal fade" id="ModalDelete" tabindex="-1" role="dialog"
                      ...
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="clCostum_delete.php" method="post">
  ...
  <div class="modal fade" id="modalSaya" tabindex="-1" role="dialog" aria-labelledby="modalSayaLabel"
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="clCostum_upload.php" method="post" enctype="multipart/form-data">
            <div class="form-row">
              <div class="form-group col-md-6">
                <label>No</label>
