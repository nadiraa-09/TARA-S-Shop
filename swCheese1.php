      ...
      <div class="row">
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
          <?php 
                  include 'koneksi.php';
                  $no = 1;
                  $sql = mysqli_query($koneksi, "select*from cheese where kode in ('1')");
                  while($data = mysqli_fetch_array($sql)){
            ?>
          <div class="thumbnail">
            <?php echo "<img src ='images/swCheese/".$data['foto']."' width = '400' height = '400'>" ;?>
            <div class="caption">
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
          <?php 
                  include 'koneksi.php';
                  $no = 1;
                  $sql = mysqli_query($koneksi, "select*from cheese where kode in ('2')");
                  while($data = mysqli_fetch_array($sql)){
            ?>
          <div class="thumbnail">
            <?php echo "<img src ='images/swCheese/".$data['foto']."' width = '400' height = '400'>" ;?>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
          <?php 
                  include 'koneksi.php';
                  $no = 1;
                  $sql = mysqli_query($koneksi, "select*from cheese where kode in ('3')");
                  while($data = mysqli_fetch_array($sql)){
            ?>
          <div class="thumbnail">
            <?php echo "<img src ='images/swCheese/".$data['foto']."' width = '400' height = '400'>" ;?>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
          <?php 
                  include 'koneksi.php';
                  $no = 1;
                  $sql = mysqli_query($koneksi, "select*from cheese where kode in ('4')");
                  while($data = mysqli_fetch_array($sql)){
            ?>
          <div class="thumbnail">
            <?php echo "<img src ='images/swCheese/".$data['foto']."' width = '400' height = '400'>" ;?>
      ...
      <div class="row">
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
          <?php 
                  include 'koneksi.php';
                  $no = 1;
                  $sql = mysqli_query($koneksi, "select*from cheese where kode in ('5')");
                  while($data = mysqli_fetch_array($sql)){
            ?>
          <div class="thumbnail">
            <?php echo "<img src ='images/swCheese/".$data['foto']."' width = '400' height = '400'>" ;?>
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
          <?php 
                  include 'koneksi.php';
                  $no = 1;
                  $sql = mysqli_query($koneksi, "select*from cheese where kode in ('6')");
                  while($data = mysqli_fetch_array($sql)){
            ?>
          <div class="thumbnail">
            <?php echo "<img src ='images/swCheese/".$data['foto']."' width = '400' height = '400'>" ;?>
