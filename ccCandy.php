      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="ccCandy1.php" class="d-none d-sm-inline-block btn btn-sm btn-warning shadow-sm"><i
                class="fas fa-fw fa-eye"></i></i> SHOW FRONT-END WEB</a>
          </div>
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-warning">CANDY</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  include 'koneksi.php';
                  $no = 1;
                  $sql = mysqli_query($koneksi, "select*from candy");
                  while($data = mysqli_fetch_array($sql)){
                  ?>
                    <tr>
                      <td><?php echo $data['candyid']; ?></td>
                      <td><?php echo $data['nama']; ?></td>
                      <td><?php echo $data['ket']; ?></td>
                      <td><?php echo $data['harga']; ?></td>
                      <td><?php echo "<img src ='images/ccCandy/".$data['foto']."' width = '100' height = '100'>" ;?>
                      </td>
                      <td><i class="fas fa-edit bg-success p-2 text-white rounded"></i>
                        <a href="#" data-role="pop" data-id="<?php echo $data['candyid'];?>">Edit</a>
                        <i class="fas fa-trash-alt bg-danger p-2 text-white rounded"></i>
                        <a href="#" data-role="pop2" data-id="<?php echo $data['candyid']?>">Delete</a>
                    </tr>
                      ...
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="ccCandy_update.php" enctype="multipart/form-data" method="post">
                              <div class="form-row">
                                <div class="form-group col-md-6">
                                  <label>No</label>
                                  <input type="text" name="candyid" class="form-control" id="candyid" readonly>
                                </div>
                              </div>
                              <div class="form-row">
                                <div class="form-group col-md-6">
                    ...
                    <div class="modal fade" id="ModalDelete" tabindex="-1" role="dialog"
                      ...
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="ccCandy_delete.php" method="post">
  ...
  <div class="modal fade" id="modalSaya" tabindex="-1" role="dialog" aria-labelledby="modalSayaLabel"
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="ccCandy_upload.php" method="post" enctype="multipart/form-data">
            <div class="form-row">
              <div class="form-group col-md-6">
                <label>No</label>
                <input type="text" name="candyid" class="form-control" id="candyid">
              </div>
            </div>
            <div class="form-row">
              <div class="form-group col-md-6">
    ...
    $("a[data-role=pop]").click(function () {
      ...
      $.ajax({
        ...
        success: function (data) {
          ...
          console.log(row['candyid']);
          $("#candyid").val(row['candyid']);
          $("#nama").val(row['nama']);
          $("#ket").val(row['ket']);
          $("#harga").val(row['harga']);
          $("#foto").val(row['foto']);
    ...
    $("a[data-role=pop2]").click(function () {
      ...
      $.ajax({
        ...
        success: function (data) {
          ...
          var row = JSON.parse(data);
          console.log(row['candyid']);
          $("#datadel2").val(row['candyid']);
          $("#datadel").text(row['candyid']);
